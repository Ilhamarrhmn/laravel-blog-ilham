...
<head>
    ...
    <title>{{ $metaTitle ?: 'Ilham Arrahman' }}</title>
    <meta name="author" content="Ilham Arrahman">
...
<header class="w-full container mx-auto">
    <div class="flex flex-col items-center py-6">
        <img src="{{asset('assets/IA.png')}}" alt="test" width="50px" height="50px">
        <a class="font-bold text-gray-800 uppercase hover:text-gray-200 text-2xl" href="{{route('home')}}">
            Ilham Arrahman
        </a>
...
<nav class="w-full py-4 border-t border-b bg-gray-100" x-data="{ open: false }">
    ...
    <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
        <div class="w-full container mx-auto flex flex-col sm:flex-row items-center justify-between text-sm font-bold uppercase mt-0 px-3 py-1">
            <div>
...
<footer class="w-full border-t bg-white pb-12">
    <div class="w-full container mx-auto flex flex-col items-center">
        <div class="uppercase py-6">&copy; ilhamarrahman.online</div>
    </div>
</footer>
